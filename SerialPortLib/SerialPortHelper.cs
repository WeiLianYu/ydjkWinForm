...
namespace SerialPortLib
{
    public class SerialPortHelper
    {
        ...
        /// <param name="strBaudRate"></param>
        /// <param name="strDataBit"></param>
        /// <param name="stopBitIndex"></param>
        /// <param name="parityIndex"></param>
        /// <param name="handler"></param>
        /// <returns></returns>
        public bool OpenSerialPort(string portName, int baudRate, int dataBit, int stopBit, int parity, SerialDataReceivedEventHandler handler = null)
        {
            try
            {
                if (!sp.IsOpen)
